...
SECRET_KEY = 'django-insecure-74oi%t31=2h=^8+_2!=*%-$8m(@1ei(8gkkd4+0p@r+lzp_83u'
...
REST_FRAMEWORK = {
  'DEFAULT_PERMISSION_CLASSES': [],
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'movies.generics.authentication.Authentication',
...
SECURITY_PASSWORD_SALT = "salt-security"
